...
class SetupCommand extends Command
{
    ...
    {
        return 'phpswitch fpm setup [--systemctl|--initd|--launchctl] [--stdout] [<build name>]';
    }
    ...
    public function options($opts)
    {
        $opts->add(
            ...
            "Start from 1.22, phpswitch automatically add --with-fpm-systemd when systemd is detected."
        );
        $opts->add(
            'initd',
    ...
    public function execute($buildName = null)
    {
        ...
        if (!$buildName) {
            throw new Exception("PHPSWITCH_PHP is not set. You should provide the build name in the command.");
        }
        ...
        if ($this->options->systemctl) {
            ...
            $file = '/lib/systemd/system/phpswitch-fpm.service';
            ...
            $this->logger->info("    sudo update-rc.d phpswitch-fpm defaults");
            ...
            $file = '/Library/LaunchDaemons/org.phpswitch.fpm.plist';
            if (!is_writable(dirname($file))) {
                $this->logger->error("$file is not writable.");
                return;
            }
...
<plist version="1.0">
  <dict>
    ...
    <true/>
    <key>Label</key>
    <string>org.phpswitch.fpm</string>
...
EOS;
    ...
    protected function generateSystemctlService($buildName, $fpmBin)
    {
        ...
        $config = <<<"EOS"
[Unit]
Description=The Phpswitch FastCGI Process Manager
...
#!/bin/sh
### BEGIN INIT INFO
# Provides:          phpswitch-fpm
# Required-Start:    \$remote_fs \$network
# Required-Stop:     \$remote_fs \$network
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: starts phpswitch-fpm
# Description:       Starts The PHP FastCGI Process Manager Daemon
### END INIT INFO

PATH=/sbin:/usr/sbin:/bin:/usr/bin
DESC="Phpswitch FastCGI Process Manager"
NAME=phpswitch-fpm
...
{
    # FIXME
    # /usr/lib/php/phpswitch-fpm-checkconf || return 1
    return 0
}
...
do_tmpfiles() {
    ...
    TMPFILES=/usr/lib/tmpfiles.d/phpswitch-fpm.conf
