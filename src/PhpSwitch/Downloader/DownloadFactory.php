...
class DownloadFactory
{
    ...
    private static $availableDownloaders = array(
        self::METHOD_PHP_CURL => 'PhpSwitch\Downloader\PhpCurlDownloader',
        self::METHOD_PHP_STREAM => 'PhpSwitch\Downloader\PhpStreamDownloader',
        self::METHOD_WGET => 'PhpSwitch\Downloader\WgetCommandDownloader',
        self::METHOD_CURL => 'PhpSwitch\Downloader\CurlCommandDownloader',
    );
    ...
    public static function getInstance(Logger $logger, OptionResult $options, $downloader = null)
    {
        if (is_string($downloader)) {
            ...
            if (class_exists($downloader) && is_subclass_of($downloader, 'PhpSwitch\Downloader\BaseDownloader')) {
